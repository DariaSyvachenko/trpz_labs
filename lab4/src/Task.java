...
public class Task {
    ...
    private TaskStatusUpdateStrategy statusUpdateStrategy;

    public void updateTaskStatus(TaskStatus newStatus) {
        this.status = newStatus;
    }

    public void setStatusUpdateStrategy(TaskStatusUpdateStrategy statusUpdateStrategy) {
        statusUpdateStrategy.updateStatus(this);
    }
}
